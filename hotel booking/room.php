...
if (isset($_POST['lowestPrice'])) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $type = $_GET['type']; // Retrieve the "city" value from the previous page
  
    $query = "SELECT * FROM room WHERE type = '$type' AND price BETWEEN $minPrice AND $maxPrice ORDER BY price ASC";
    $result = mysqli_query($con, $query);
